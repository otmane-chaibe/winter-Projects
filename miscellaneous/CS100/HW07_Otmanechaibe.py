...
print("Bells - a/an: ", litCricFriend(["a", "an"], theBells))
print("Canto - a/an: ",litCricFriend(["a", "an"], cantoXII))
print("Bells - the: ",litCricFriend(["the"], theBells))
print("Canto - then: ",litCricFriend(["the"], cantoXII))
...
'''
Bells - a/an: 0.03494176372712146
Canto - a/an: 0.009615384615384616

In Bells, the words a/an make up about 3% of the words; in Canto, a/an make up about 1% of the words. Based on a general skimming of both readings, it doesn't seem as if either poet intentionally uses a/an as a stylistic choice - rather, it is simply used as grammatically appropriate. Therefore, they do not 'use' a/an differently.
Bells - the: 0.13643926788685523
Canto - the: 0.05448717948717949

The word 'the' makes up nearly 14% of the words in Bells, while it only makes up 5% of the words in Canto. While Canto seems to use 'the' only as necessary in proper sentences, Bells specifically refers to 'the bells' as a repeating stylistic choice throughout the piece. Therefore, Bells and Canto use the word 'the' differently from one another.
'''
